      ...
      const timeout =
        setTimeout(() => {
          ...
          finish(
            reject,
            new Error(
              `Deriv WebSocket timed out waiting for ${expectedType}.`
            )
          );
...
export async function onRequest(context) {
  ...
  /* ===================================================
     ...
     ONE BUTTON:
     1. Get fresh proposal
     2. Immediately buy it
  =================================================== */
  ...
  if (
    ...
    try {
       ...
       * Get a NEW OTP.
       *
       * Deriv says the OTP is single-use,
       * so we immediately connect using
